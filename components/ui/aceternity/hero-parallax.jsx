...
export const HeroParallax = ({ aboutTitle, aboutDescription, products }) => {
...
export const Header = ({ aboutTitle, aboutDescription }) => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      Join us in this extraordinary celebration, reflecting on milestones, setting the stage for limitless possibilities, and shaping the future where ideas soar. PROCOM&apos;24 is not just an event; it&apos;s a legacy of inspiration, resilience, and evolution.
      </p>
    </div>
  );
};
